...
public class ObservarAdapter extends FirestoreRecyclerAdapter<Ejercicio, ObservarAdapter.ViewHolder> {
     ...
     * @param options
     */
    public ObservarAdapter(@NonNull FirestoreRecyclerOptions<Ejercicio> options, Activity activity, FragmentManager fmanager) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull Ejercicio ejercicio) {
        ...
        holder.btnEditar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                EditObservarFragment editGrupoFragment = new EditObservarFragment();
    ...
    private void deleteEjercicio(String id) {
        firestore.collection("Ejercicios - Observación").document(id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ObservarAdapter.ViewHolder(view);
    }
