...
import com.example.llm.ui.ejercicios.manageEjercicios.EditPincharFragment;
...
public class PincharAdapter extends FirestoreRecyclerAdapter<Ejercicio, PincharAdapter.ViewHolder> {
     ...
     * @param options
     */
    public PincharAdapter(@NonNull FirestoreRecyclerOptions<Ejercicio> options, Activity activity, FragmentManager fmanager) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull Ejercicio ejercicio) {
        ...
        holder.layout.setBackgroundResource(R.color.green_100);

        holder.btnEditar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditPincharFragment editGrupoFragment = new EditPincharFragment();
    ...
    private void deleteEjercicio(String id) {
        firestore.collection("Ejercicios - Pinchar y Arrastrar").document(id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PincharAdapter.ViewHolder(view);
    }
